...
This wiki uses the very popular [Markdown](http://daringfireball.net/projects/markdown/) syntax.


Bitbucket Supported Markdown for READMEs, comments, and Wiki
====================

Here is a demo of all the Markdown markup supported by Bitbucket for wiki pages and for `README.md` files in repositories. This is not a complete list of examples, but should get you productive quickly. For the entire docs and a deeper explanation of Markdown, go to the [Markdown][fireball] site.
...
To do this, do not indent the block. Start the block with ` ``` ` three ticks. Then, provide the type of syntax you are using.  There is a [the vast library of Pygment lexers][lexers]. Bitbucket accepts the 'short name' or the 'mimetype' of anything in there.
