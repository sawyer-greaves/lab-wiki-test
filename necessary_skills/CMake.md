...
Our lab has a simple [example CMake-based C++ project](https://bitbucket.org/mmrobotics/example-qt-cmake-project/src/master/) that depends on the [Qt Framework](Qt.md) and can serve as a template for projects built with CMake.
