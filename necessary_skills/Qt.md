...
Our lab has a simple [example CMake-based C++ project](https://bitbucket.org/utahtelerobotics/example-qt-cmake-project/src/master/) that depends on the Qt Framework and can serve as a template for Qt projects built with CMake if you prefer not to use Qt Creator to develop your program. If you are using Qt Creator, a suitable `CMakeLists.txt` file will be automatically generated for you when you create a new CMake-based project.
